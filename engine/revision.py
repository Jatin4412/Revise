...
def should_replace(previous: Version, candidate: Version) -> bool:
    """Only replace a version when the candidate is demonstrably at least as good."""
...
def revision_instructions(result: EvaluationResult) -> tuple[str, ...]:
    """Turn evaluation findings into bounded instructions for the next Primary pass."""
