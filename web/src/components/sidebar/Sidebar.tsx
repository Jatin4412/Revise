...
export function Sidebar({ sessions, hasMessages, onNewSession }: SidebarProps) {
  return (
    <aside className="flex min-h-0 w-full flex-col rounded-[clamp(1.25rem,1.8vw,1.6rem)] border border-white/[0.07] bg-reiterate-deep/70 p-[clamp(1rem,1.5vw,1.5rem)] shadow-[0_1.5rem_4rem_rgba(0,0,0,.18)] backdrop-blur-2xl lg:w-[clamp(15rem,18vw,18rem)] lg:shrink-0">
      <div className="mb-[clamp(1.25rem,3vh,2.25rem)] flex items-center justify-between px-1">
        ...
        <span className="grid size-8 place-items-center rounded-[0.8rem] border border-reiterate-orange/20 bg-gradient-to-br from-reiterate-orange/20 to-reiterate-red/8 text-sm font-bold">R</span>
      </div>
